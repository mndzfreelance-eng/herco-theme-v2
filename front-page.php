...
$brand_names = array( '3M', 'WD-40', 'Bosch', 'DeWalt', 'Stanley', 'Bahco', 'Yale', 'Briggs & Stratton', 'Black+Decker', 'Armor All', 'Devcon', 'Dorma' );
			...
			<?php foreach ( $dist_cards as $index => $card ) : ?>
				<div class="group bg-surface-container-lowest border border-border-gray relative overflow-hidden hover:border-industrial-gold transition-colors duration-300 flex flex-col" data-reveal>
					<div class="aspect-[4/5] overflow-hidden relative">
						...
						<?php endif; ?>
						<div class="absolute top-4 left-4 bg-surface-container-lowest/90 backdrop-blur-sm px-3 py-1 text-technical-caps font-technical-caps text-heritage-navy border border-border-gray"><?php echo esc_html( 'CH-0' . ( $index + 1 ) ); ?></div>
					</div>
...
<section class="py-section-gap bg-surface-container-lowest border-y border-border-gray">
	...
	<div class="marquee" aria-label="<?php esc_attr_e( 'Brands distributed by Herco', 'herco' ); ?>"><div class="marquee-track text-2xl font-bold tracking-tight text-slate-black/70"><?php for ( $i = 0; $i < 2; $i++ ) : foreach ( $brand_names as $brand_name ) : ?><span><?php echo esc_html( $brand_name ); ?></span><?php endforeach; endfor; ?></div></div>
...
<section class="py-section-gap bg-surface"><div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop"><div class="bg-heritage-navy relative overflow-hidden p-12 md:p-20 text-center" data-reveal><div class="absolute inset-0 opacity-5 pointer-events-none hairline-grid"></div><div class="relative z-10 max-w-3xl mx-auto"><span class="text-technical-caps font-technical-caps text-industrial-gold uppercase tracking-widest"><?php esc_html_e( 'Let\'s talk', 'herco' ); ?></span><h2 class="text-headline-lg-mobile md:text-headline-lg font-headline-lg text-white mt-4 mb-6"><?php esc_html_e( 'Bring your brand to the Filipino market or stock the brands shoppers ask for.', 'herco' ); ?></h2><p class="text-body-lg font-body-lg text-stucco-white/80 mb-10"><?php esc_html_e( 'Whether you\'re a global principal seeking distribution or a retailer building your shelves, Herco is ready to partner.', 'herco' ); ?></p><div class="flex flex-col sm:flex-row items-center justify-center gap-4"><a class="w-full sm:w-auto inline-flex items-center justify-center bg-industrial-gold text-heritage-navy text-label-md font-label-md rounded px-8 py-3.5 hover:bg-industrial-gold/90 transition-colors" href="<?php echo esc_url( herco_page_url( 'contact' ) ); ?>"><?php esc_html_e( 'Start a conversation', 'herco' ); ?></a><a class="w-full sm:w-auto inline-flex items-center justify-center border border-white/40 text-white text-label-md font-label-md rounded px-8 py-3.5 hover:bg-white/10 transition-colors" href="<?php echo esc_url( herco_page_url( 'distribution' ) ); ?>"><?php esc_html_e( 'Explore channels', 'herco' ); ?></a></div></div></div></div></section>
