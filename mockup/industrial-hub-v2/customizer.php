...
function herco_customize_register($wp_customize) {
    ...
    herco_add_image_control($wp_customize, 'herco_about_image', __('About page main photo', 'herco'), 'herco_about', __('Main image for the "Who We Are" section. Min. 1200x800 recommended.', 'herco'));
    ...
    /* ── Distribution Page ────────────────────────────────── */
    $wp_customize->add_section('herco_distribution', [
        'title'       => __('Herco Distribution Page', 'herco'),
        'description' => __('Images for the Distribution Channels template.', 'herco'),
        'priority'    => 32,
    ]);
    herco_add_image_control($wp_customize, 'herco_modern_retail_logo_wilcon', __('Modern Retail Logo: Wilcon Depot', 'herco'), 'herco_distribution', __('Upload logo for Wilcon Depot.', 'herco'));
    herco_add_image_control($wp_customize, 'herco_modern_retail_logo_handyman', __('Modern Retail Logo: Handyman', 'herco'), 'herco_distribution', __('Upload logo for Handyman.', 'herco'));
    herco_add_image_control($wp_customize, 'herco_modern_retail_logo_doitbest', __('Modern Retail Logo: Do-it-Best', 'herco'), 'herco_distribution', __('Upload logo for Do-it-Best.', 'herco'));
    herco_add_image_control($wp_customize, 'herco_modern_retail_logo_truevalue', __('Modern Retail Logo: True Value', 'herco'), 'herco_distribution', __('Upload logo for True Value.', 'herco'));
    herco_add_image_control($wp_customize, 'herco_modern_retail_logo_robinsons', __('Modern Retail Logo: Robinsons Builders', 'herco'), 'herco_distribution', __('Upload logo for Robinsons Builders.', 'herco'));
    /* ── Global / inner pages ─────────────────────────────── */
