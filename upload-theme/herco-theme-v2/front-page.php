...
<section class="py-section-gap bg-surface">
	<div class="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop">
		<div class="max-w-2xl mb-16" data-reveal>
			...
			<h2 class="text-headline-lg-mobile md:text-headline-lg font-headline-lg text-heritage-navy mt-4 mb-4"><?php esc_html_e( 'Our distribution network brings brands closer to Filipino market.', 'herco' ); ?></h2>
			<div class="w-16 h-1 bg-industrial-gold mb-6"></div>
			<p class="text-body-lg font-body-lg text-on-surface-variant"><?php esc_html_e( 'Through our established network across traditional trade, modern retail, e-commerce, and industrial channels, Herco helps brands enter, scale, and succeed nationwide—supported by proven logistics, local market expertise, marketing, and dependable service.', 'herco' ); ?></p>
		</div>
