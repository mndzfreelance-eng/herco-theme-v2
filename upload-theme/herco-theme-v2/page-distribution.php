...
<section class="bg-surface pt-16 md:pt-20 px-margin-mobile md:px-margin-desktop">
	<div class="max-w-container-max mx-auto grid grid-cols-2 lg:grid-cols-4 gap-gutter">
		<a class="group bg-surface-container-lowest border border-border-gray p-6 hover:border-industrial-gold transition-colors" href="#traditional"><span class="font-technical-caps text-technical-caps text-on-surface-variant uppercase">01</span><h3 class="font-subheading text-subheading text-heritage-navy mt-2"><?php esc_html_e( 'Traditional Stores', 'herco' ); ?></h3><span class="inline-flex items-center gap-1 text-industrial-gold text-label-md font-label-md mt-3 group-hover:gap-2 transition-all"><?php esc_html_e( 'Learn more', 'herco' ); ?> <span class="material-symbols-outlined text-sm">arrow_forward</span></span></a>
		<a class="group bg-surface-container-lowest border border-border-gray p-6 hover:border-industrial-gold transition-colors" href="#modern"><span class="font-technical-caps text-technical-caps text-on-surface-variant uppercase">02</span><h3 class="font-subheading text-subheading text-heritage-navy mt-2"><?php esc_html_e( 'Modern Retail', 'herco' ); ?></h3><span class="inline-flex items-center gap-1 text-industrial-gold text-label-md font-label-md mt-3 group-hover:gap-2 transition-all"><?php esc_html_e( 'Learn more', 'herco' ); ?> <span class="material-symbols-outlined text-sm">arrow_forward</span></span></a>
		<a class="group bg-surface-container-lowest border border-border-gray p-6 hover:border-industrial-gold transition-colors" href="#ecommerce"><span class="font-technical-caps text-technical-caps text-on-surface-variant uppercase">03</span><h3 class="font-subheading text-subheading text-heritage-navy mt-2"><?php esc_html_e( 'E-Commerce', 'herco' ); ?></h3><span class="inline-flex items-center gap-1 text-industrial-gold text-label-md font-label-md mt-3 group-hover:gap-2 transition-all"><?php esc_html_e( 'Learn more', 'herco' ); ?> <span class="material-symbols-outlined text-sm">arrow_forward</span></span></a>
		<a class="group bg-surface-container-lowest border border-border-gray p-6 hover:border-industrial-gold transition-colors" href="#industrial"><span class="font-technical-caps text-technical-caps text-on-surface-variant uppercase">04</span><h3 class="font-subheading text-subheading text-heritage-navy mt-2"><?php esc_html_e( 'Industrial', 'herco' ); ?></h3><span class="inline-flex items-center gap-1 text-industrial-gold text-label-md font-label-md mt-3 group-hover:gap-2 transition-all"><?php esc_html_e( 'Learn more', 'herco' ); ?> <span class="material-symbols-outlined text-sm">arrow_forward</span></span></a>
	</div>
</section>
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
			...
			<div class="order-1 lg:order-2">
				...
				<div class="flex flex-wrap gap-3">
					<?php foreach ( array( 'Wilcon Depot', 'Handyman', 'Do-it-Best', 'True Value', 'Robinsons Builders' ) as $partner ) : ?>
						<span class="inline-flex items-center gap-2 bg-surface border border-border-gray px-4 py-2 text-label-md font-label-md text-on-surface"><span class="w-1.5 h-1.5 bg-industrial-gold rounded-full"></span> <?php echo esc_html( $partner ); ?></span>
					<?php endforeach; ?>
				</div>
			</div>
		</div>
