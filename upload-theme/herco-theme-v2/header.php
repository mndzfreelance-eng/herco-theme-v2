					...
					<div class="mega-panel p-8 border border-border-gray bg-white" style="width: 640px; left: 50%; transform: translateX(-50%);">
						<div class="grid grid-cols-2 gap-8">
							<div>
								...
								<ul class="space-y-3">
									<li><a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="flex items-center gap-3 text-body-md font-body-md text-on-surface-variant hover:text-industrial-gold transition-colors"><span class="material-symbols-outlined text-industrial-gold text-base">bolt</span><?php esc_html_e( 'Power Tools', 'herco' ); ?></a></li>
									<li><a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="flex items-center gap-3 text-body-md font-body-md text-on-surface-variant hover:text-industrial-gold transition-colors"><span class="material-symbols-outlined text-industrial-gold text-base">build</span><?php esc_html_e( 'Hand Tools', 'herco' ); ?></a></li>
									<li><a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="flex items-center gap-3 text-body-md font-body-md text-on-surface-variant hover:text-industrial-gold transition-colors"><span class="material-symbols-outlined text-industrial-gold text-base">directions_car</span><?php esc_html_e( 'Automotive Care', 'herco' ); ?></a></li>
									<li><a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="flex items-center gap-3 text-body-md font-body-md text-on-surface-variant hover:text-industrial-gold transition-colors"><span class="material-symbols-outlined text-industrial-gold text-base">lock</span><?php esc_html_e( 'Security & Access', 'herco' ); ?></a></li>
									<li><a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="flex items-center gap-3 text-body-md font-body-md text-on-surface-variant hover:text-industrial-gold transition-colors"><span class="material-symbols-outlined text-industrial-gold text-base">science</span><?php esc_html_e( 'Adhesives & Chemicals', 'herco' ); ?></a></li>
								</ul>
							</div>
							<div>
						...
						<div class="mt-6 pt-6 border-t border-border-gray">
							<a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="inline-flex items-center gap-2 text-industrial-gold text-label-md font-label-md hover:gap-3 transition-all"><?php esc_html_e( 'View All 50+ Brands', 'herco' ); ?> <span class="material-symbols-outlined text-base">arrow_forward</span></a>
						</div>
					</div>
				</div>
				<div class="relative mega-nav-item" data-mega-menu>
				...
				<div class="py-3 border-b border-border-gray">
					...
					<div class="mobile-mega-panel hidden">
						<div class="pt-3 flex flex-col items-start">
							...
							<a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="py-2 pl-4 text-label-md font-label-md text-on-surface-variant w-full text-left"><?php esc_html_e( 'Power Tools', 'herco' ); ?></a>
							<a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="py-2 pl-4 text-label-md font-label-md text-on-surface-variant w-full text-left"><?php esc_html_e( 'Hand Tools', 'herco' ); ?></a>
							<a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="py-2 pl-4 text-label-md font-label-md text-on-surface-variant w-full text-left"><?php esc_html_e( 'Automotive Care', 'herco' ); ?></a>
							<a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="py-2 pl-4 text-label-md font-label-md text-on-surface-variant w-full text-left"><?php esc_html_e( 'Security & Access', 'herco' ); ?></a>
							<a href="<?php echo esc_url( herco_page_url( 'brands' ) ); ?>" class="py-2 pl-4 text-label-md font-label-md text-on-surface-variant w-full text-left"><?php esc_html_e( 'Adhesives & Chemicals', 'herco' ); ?></a>
						</div>
					</div>
				</div>
				<div class="py-3">
